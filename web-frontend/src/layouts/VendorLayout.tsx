          ...
          <div className="flex items-center gap-2 md:gap-4 shrink-0">
            ...
            <div className="flex items-center gap-2 md:gap-3 group cursor-pointer">
              <div className="flex flex-col items-end hidden sm:flex">
                ...
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none">Vendor Portal</span>
              </div>
              <div className="w-8 h-8 md:w-9 md:h-9 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 border border-emerald-100 shadow-sm group-hover:bg-emerald-600 group-hover:text-white transition-all overflow-hidden shrink-0">
                {user?.avatar ? (
