          ...
          <div className="bg-slate-900 rounded-[24px] p-6 text-white relative overflow-hidden">
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-xs font-bold tracking-tight">Access Secret</h4>
              </div>
              <p className="text-[10px] font-medium text-slate-400 leading-relaxed mb-4">
                Platform access is restricted via your private environment secret.
              </p>
              <div className="p-3 bg-white/5 border border-white/10 rounded-xl">
                <code className="text-[10px] font-mono text-blue-300">ADMIN_SECRET_KEY</code>
              </div>
            </div>
